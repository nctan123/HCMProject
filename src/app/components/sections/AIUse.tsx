import {BookOpen, Brain, CheckCircle, Edit3, Mic, Users, Video} from "lucide-react";
            ...
            <div
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div
                            ...
                            <div className="text-center">
                                <div
                                    className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 p-2">
                        ...
                        <div
                            ...
                            <div className="text-center">
                                <div
                                    className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 p-2">
                                    <img src="/logo-aivoice-new-v2.png" alt="Vbee AI Voice"
                ...
                <div className="mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div
                            className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-6 rounded-2xl border border-slate-600/50">
                    ...
                    <div className="space-y-6">
                        <div
                            ...
                            <ul className="space-y-3 text-gray-300 text-sm">
                                <li>• "Dựa trên file giáo trình 'Giáo trình Tư tưởng Hồ Chí Minh, dùng cho sinh viên bậc
                                    đại học hệ không chuyên ngành lý luận chính trị - Bản dự thảo', hãy liệt kê các tiêu
                                    đề chính trong Chương 3 và tóm tắt nội dung từng tiêu đề."
                                </li>
                                <li>• "Dựa trên nội dung từng tiêu đề, hãy viết kịch bản nội dung chi tiết, đảm bảo
                                    truyền tải đúng các kiến thức trọng tâm của Chương 3 và ứng với các CLO2 được đề
                                    ra."
                                </li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <ul className="space-y-3 text-gray-300 text-sm">
                                ...
                                <li>• "Từ cấu trúc và nội dung đã truy xuất của chương 3, hãy tạo sơ đồ kiến thức dạng
                                    mindmap"
                                </li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <ul className="space-y-3 text-gray-300 text-sm">
                                ...
                                <li>• Chọn giọng đọc: Lựa chọn giọng nam/nữ, miền Bắc/Nam và điều chỉnh tốc độ, ngữ
                                    điệu
                                </li>
                ...
                <div className="mb-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div
                            ...
                            <ul className="space-y-2 text-gray-300 text-sm">
                                <li>• <strong>Kho dữ liệu học tập đã được hệ thống hóa</strong>, gồm: giáo trình, CLO,
                                    ghi chú bài giảng
                                </li>
                                <li>• Bản cập nhật nội dung liên tục để đảm bảo AI chỉ phân tích trên đúng phiên bản mới
                                    nhất
                                </li>
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-6">
                        <div
                            ...
                            <ul className="space-y-2 text-gray-300 text-sm">
                                <li>• Sắp xếp lại bố cục cho mạch lạc, dễ hiểu, lược bỏ các ý thừa giữ lại nội dung cần
                                    thiết
                                </li>
                                <li>• Biên soạn lại kịch bản từ bản nháp AI: viết lại lời dẫn, phân cảnh, câu chuyển
                                    đoạn mạch lạc
                                </li>
                                <li>• Bổ sung ví dụ, tình huống minh họa để tăng tính thực tiễn và sinh động cho nội
                                    dung
                                </li>
                                <li>• Phân công các thành viên viết – đọc thử - góp ý để hoàn thiện kịch bản chính
                                    thức
                                </li>
                                <li>• Chia nhỏ kịch bản thành từng đoạn để đồng bộ với slide, audio và video trình bày
                                </li>
                            </ul>
                        </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div
                            className="bg-gradient-to-br from-red-500/20 to-orange-500/20 p-6 rounded-2xl border border-red-500/30">
                ...
                <div
                    className="bg-gradient-to-br from-pink-500/20 to-red-500/20 p-8 rounded-2xl border border-pink-500/30">
                    <h4 className="text-2xl font-bold text-red-400 mb-6 text-center">7. CAM KẾT LIÊM CHÍNH HỌC
                        THUẬT</h4>
